<?php
$langArray = array(
    "title" => "Švajdlenka's family",
    "english" => "English",
    "slovak" => "Slovak",
    "menu-basic" => "Basic info",
    "menu-members" => "Family members",
    "menu-images" => "Photos",
    "basic-title" => "Welcome to our pages",
    "members-title" => "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus accusantium illum itaque necessitatibus nemo perferendis, placeat possimus reprehenderit sapiente sequi?",

    "richard-lead" => "Student, Artist, The oldest gamer",
    "robert-lead" => "Student, Diplomat, Breeder, Middle gamer",
    "patrik-lead" => "Schoolchild, The youngest gamer",
    "angelika-lead" => "Mother, Backer, Creative heart",
    "juraj-lead" => "Father, Carpenter, Developer",
